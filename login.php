                ...
                <div class="row" style="margin-left: 25%;">
                    <div class="col-xl-7 col-lg-12 col-md-12">
                        <div class="login-header">
                            <h4 class="text-center">U2T Project</h4>
                            <h6 class="text-center login-small">(Kasetsart U - Buapaktha subdistrictX)</h6>
                        </div>
...
<div class="modal fade" id="ChangeModal" name="ChangeModal" tabindex="-1" role="dialog" style="margin-top: 10%;">
    <form method="post" id="change_password" name="change_password" action="forget_password.php">
            ...
            <div class="modal-content">
                <div class="changepass">
                    ...
                    <div class="modal-body" id="ChangeModalBody">
                        <div class="container">
                            <div class="form-label-group">
                                <label for="inputEmail">ชื่อผู้ใช้</label>
                                <div class="col-12" style="padding: 0px;">
                                    <input type="text" name="f_username" id="f_username" class="form-control" placeholder="username" required autofocus>
                                </div>
                            </div>
                            <br>
                            <br>
                            <div class="form-label-group">
                                ...
                                <div class="col-12" style="padding: 0px;">
                                    <input class="form-control" type="password" name="forget_password" id="forget_password" placeholder="Password" required>
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="save" id="save" value="insert" class="btn btn-success save">ยืนยัน</button>
