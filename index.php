...
$PRODUCTBYTYPE_FOOD_N = getProductTypeByDay(1);
$PRODUCTBYTYPE_DRINK_N = getProductTypeByDay(2);
                ...
                <div class="col-lg-8 col-md-8">
                    <ul class="filter__controls">
                        ...
                        for ($i = 1; $i < count($PRODUCT_TYPE); $i++) {
                            echo '<li data-filter=".' . $PRODUCT_TYPE[$i]["type_eng"] . '">' . $PRODUCT_TYPE[$i]["type"] . '</li>';
                        }
                        ?>
                    </ul>
                </div>
